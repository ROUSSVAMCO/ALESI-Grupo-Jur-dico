...
def contrato_pdf_response(cliente, expediente, datos):
    ...
    prestador = (datos.get("prestador") or "Lic. Rosa Isela Vázquez Medina").upper()
    personal = (datos.get("personal_atendio") or prestador).upper()
